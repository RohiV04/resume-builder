          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                name="proj1_title"
                id="proj1_title"
                value={formData.project[0].proj1_title}
                onChange={(e)=>{
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                name="proj1_link"
                id="proj1_link"
                value={formData.project[0].proj1_link}
                onChange={(e)=>{
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <textarea
                name="proj1_desc"
                id="proj1_desc"
                value={formData.project[0].proj1_desc}
                onChange={(e)=>{
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                name="proj2_title"
                id="proj2_title"
                value={formData.project[1].proj2_title}
                onChange={(e)=>{
                  setFormData({...formData,proj1_title:e.target.value})
                }}
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                name="proj2_link"
                id="proj2_link"
                value={formData.project[1].proj1_link}
                onChange={(e)=>{
                  setFormData({...formData,proj1_link:e.target.value})
                }}
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <textarea
                name="proj2_desc"
                id="proj2_desc"
                value={formData.project[1].proj2_desc}
                onChange={(e)=>{
